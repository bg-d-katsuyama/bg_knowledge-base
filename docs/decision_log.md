...
- [x] **久保田様向けセットアップ手順書（Word・v1.0）作成** （2026-06-12）
- [x] **手順書を v1.1 に改訂（Mac 対応・受け渡し情報シート・勝山様向け準備章＝送付前に削除する想定）** （2026-06-12）
...
- [ ] 久保田様への事前確認（GitHub アカウント / Claude プラン Pro 以上。PC は **Mac と確認済み**＝手順書 v1.1 で対応 2026-06-12）
- [ ] GitHub コラボレータ招待
